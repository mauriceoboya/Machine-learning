...
# Read data from the GitHub raw URL
github_raw_url = 'https://raw.githubusercontent.com/mauriceoboya/Machine-learning/main/unsupervised_models/Analytics_data.csv'
...
st.subheader('Findings')
st.write("The 'Total Revenue by Agent' plot shows the total revenue generated by each agent. Agent with highest bar (Allan Mutuota) contribute more to the overall revenue. This can be a key metric to identify top-performing agents in terms of revenue generation.")
